...
class vocabulary_TestApp(App):
    ...
    def change_value(self, btn):  # fonction called by the 'collect reward' button
        ...
        if (self.reward.opacity != 0):
            ...
            if len(self.inputword)>0:
                self.correct_rate = self.nb_letters/len(self.inputword)
            else:
                self.correct_rate = 0
            data=str(self.correct_rate)
            print(data)
            ...
            proc = subprocess.Popen([r"C:\anaconda3\envs\python38\python.exe",
                                     r"C:/Users/Administrator/PycharmProjects/pythonProject1/main.py"],
            ...
            self.volume_default = float(my_list[0])
            self.speed_default = float(my_list[1])
            self.pitchShift_default = float(my_list[2])
            self.enunciation_default = float(my_list[3])
            print(self.volume_default, self.speed_default, self.pitchShift_default, self.enunciation_default)
